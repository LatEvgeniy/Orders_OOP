...
INITIAL_PRICE_INDEX  = 7
FILL_PRICE_INDEX     = 8

INITIAL_VOLUME_INDEX = 9
FILL_VOLUME_INDEX    = 10
...
# example: TAG_LIST[round((21 * index + 25) % 0.99) % 8]
#                   values list    | mul before round | increment | coeff modulo | list modulo
TAG_LIST_FILLING = [TAG_LIST,        21,                25,         0.99,          8]
...
INFO_DATA_INSERTED_INTO_DATABASE = "Данные успешно добавленны в базу данных"

# Exception message
MORE_ONE_INSTANCE_EXCEPTION_MESSAGE  = "You can not create another instance of this class"

# Query for insert in database
INSTER_QUERY = f"insert into %s(Order_ID, Provider, Direction, Instrument, Creation_date, Change_date,\
